    ...
    <style>
        * {
        ...
        #theme-1 { background: linear-gradient(45deg, #4F46E5, #7C3AED, #C084FC, #FFFFFF); }
        #theme-2 { background: linear-gradient(45deg, #4F46E5, #7C3AED, #C084FC, #FFFFFF); }
        #theme-3 { background: linear-gradient(45deg, #4F46E5, #7C3AED, #C084FC, #FFFFFF); }
        #theme-4 { background: linear-gradient(45deg, #4F46E5, #7C3AED, #C084FC, #FFFFFF); }
